...
// Jinny Info
function setJinnyInfo(jsonStr) {
	var json = JSON.parse(jsonStr);
	var parentElm = document.getElementById("jinny-information-content");
...
function fetchJinnyInfo() {
	httpRequestAsync("GET", "/api/jinnyInfo", setJinnyInfo);
}
